...
int main()
{
    ...
    Ce = ((dist_d * 360) / ang_a); // Equação: Produto da dist_d multiplicado por 360 e dividido pelo ang_a resultando na circuferencia em estadios.
    Ckm = ((Ce * 176.4) / 1000);   // Transformando a circunferecia da unidade estadios para quilometros.
